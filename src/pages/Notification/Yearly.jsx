...
const ReportNotificationWeekForm = ({ notification, onUpdate }) => {
    ...
    useEffect(() => {
        const fetchWeek = async () => {
            try {
                const { data } = await api.get("/report-notifications-admin/4",{
                    params: {
    ...
    return (
        <TableHearder title="Điều chỉnh thông báo theo năm" backlink="/notification">
