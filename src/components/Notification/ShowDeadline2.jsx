...
const ReportNotificationScheduler = ({
    ...
    const calculateTimes = (noti) => {
        ...
        if (type === "weekly") {
            // 🔹 Áp dụng cách tính tuần theo quy tắc Việt Nam (thứ Hai bắt đầu)
            const today = new Date();
            const { year: vnYear, week: vnWeek } = getVNWeekYear(today);

            // Ngày bắt đầu tuần theo start_day (VD: thứ 2)
